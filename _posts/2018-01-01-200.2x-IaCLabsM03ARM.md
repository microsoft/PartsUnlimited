---
layout: page
title:  DevOps200.2x Infrastructure as Code - M03 Azure Automation Labs
category: IaC
order: 4
---
...
<h2><span style="color: #0000CD;"> Module 3 Labs: ARM Templates  </span></h2>
...
<h3><span style="color: #0000CD;"> Generate an ARM template based on an existing resource group (Portal).</span></h3> 
1.	From the Azure portal, navigate to the **rg1** resource group. On the resource group blade, click **Automation script**. This will generate a template containing definition of all resources contained within the resource group.  
2.	Click **Add to library**. This will store the template within your Azure subscription.  
 
 
  
<h3><span style="color: #0000CD;"> Apply a template that removes all resources in a resource group (Portal). </span></h3>
