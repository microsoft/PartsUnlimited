...
-  Deploy a Quick Start ARM Template from GitHub
...
### Task 1: Deploy a Quick Start ARM Template from GitHub
...
8. Connect to the Linux VM, on a windows OS you can use **PuTTY** or **Bash on Ubuntu on Windows**
...
### Task 2: Deploy a template using Powershell that removes all resources in a resource group.
...
### Task 3: Edit and Deploy template via the Azure Portal
