...
1.	On your local machines, create the following Azure Resource Manager template and save it as **EmptyTemplate.json**.
    ...
    **Note:** Alternatively you can copy a version of the **Emptytemplate.json** file from github at https://github.com/Microsoft/PartsUnlimited/tree/master/Labfiles/Devops200.2x-InfrastructureasCode/Mod03 and use that instead of creating the .json file yourself. 
...
```
2.	On your lcoal machines, start **Windows PowerShell** or the Windows **PowerShell IDE** as Administrator 
