...
6.	Back on the **Custom deployment** blade, use the following settings: 
    ...
    - Resource group = **DevOpsLab1RG** (or whatever you called your resource group earlier),
    - Virtual Machines_vm1_admin Password = **Pa55w.rd1234**
    - Virtual machines_vm2_admin Password = **Pa55w.rd1234**
