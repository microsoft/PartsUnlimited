...
1.	From the Azure portal, navigate to the **DevOpsLab1RG** resource group, or whatever name you called the resource group generated in the Module 1 lab [Azure Automation Runbook Deployments](https://microsoft.github.io/PartsUnlimited/iac/200.2x-IaCM01AzureAuto.html) that contains your deployed resources, such as VMs, LB etc i.e. not the resource group containing you Automation account and assets. 
...
3.	From **Windows PowerShell**, sign in to your Azure subscription by running the command
    ```powershell
    Add-AzureRmAccount
    ```
...
5.	Still in Windows PowerShell, define a variable specifying the location of the JSON template by running the cmmand
...
6.	From Windows PowerShell, deploy the template to the **DevOpsLab1RG** resource group by running 
