...
In this lab we will create an Azure Resource manager template, we will then separate out our some component resources by linking templates to modularize the resources. We will then create a custom Script extension as part of our template definition, finally deploying and then validating the deployment.


<h3><span style="color: #0000CD;">DevOps Course Source  - to be updated for openeedx link details.....</span></h3>
...
- Create linked template to modularize the resource definitions
- Create Custom Script extension to install IIS 
...
### Task 2: Create linked template to modularize the resource definitions
...
### Task 3: Create Custom Script extension to install IIS 
...
### Task 4: Deploy resources to Azure
...
- Created Resource Manager template
- Created linked template to modularize the resource definitions
- Created Custom Script extension to install IIS
