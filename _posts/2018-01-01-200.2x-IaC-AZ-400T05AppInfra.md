...
2. Deploy the template by running the command
    ...
    ```
3. Either via the Azure cli or the Azure Portal verify the virtual machine and storage resources were all created successfully
