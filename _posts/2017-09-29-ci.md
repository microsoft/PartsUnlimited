...
**1. Import Source Code into your VSTS Account:** In this step, you will import the source files from a public GitHub repo into your VSTS source control. There are a few ways to do this such as using the Git command line, or using Visual Studio, but we will just use the import a repository functionality in VSTS.  
