...
The Git repo you just downloaded currently has a remote called _origin_ that points to the GitHub repo.  You check the repo details by running the command
...
>**Note:** Scroll through the available templates and as you can see, you can build many app types on VSTS, including Universal Windows Apps & Xamarin Android/IOS, Xcode and many more.
