...
16. If you have time you could run the release a couple of times woth the above variations, and verify it runs successfully, each time checking the Logs, and various configuration options.
