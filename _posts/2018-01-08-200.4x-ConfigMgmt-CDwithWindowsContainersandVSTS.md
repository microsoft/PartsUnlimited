...
4. Enable sharing of a local drive in rdp session to allow you copy and paste some details you will need during the configuration of the agent by clicking **show options** in the **remote desktop connection** dialogue, then going to the **Local Resources** tab and clicking on **More...**
