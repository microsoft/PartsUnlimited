...
9. Save the flie, then push the changes to your Azure Devops repo by clicking the **Manage Connections** icon and clicking **Sync**. Then clicking **commit** for your listed changes to commit them changes you made to the Dockerfile to your local repo. Then click **push** to push the changes to you Azure DevOps project repo.
