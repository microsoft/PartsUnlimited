...
- Visual Studio 2017
- PartsUnlimited website deployed to a Microsoft Azure Web App (see [link](https://github.com/Microsoft/PartsUnlimited/blob/aspnet45/docs/Deployment.md)).  For our purposes, we will use the PartsUnlimited website deployed at <a href="http://cdrm-pu-demo-dev.azurewebsites.net/" target="_blank"><span style="color: #0066cc;" color="#0066cc">http://cdrm-pu-demo-dev.azurewebsites.net/</span></a>
