...
2.	Click **Browse Gallery**, search for and choose to import the **AzureRM.Network** module. Import any dependancies that you may be prompted as required also. 
...
- Name: **ResourceGroupName** 
    - Description: **leave blank**
    - Type: **String** 
    - Value: *a new Resource group name, different to the name of the resource group you specified earlier in this lab. Use a short name such as **rg1** for example, as the name is appended to other resource names, and soe resources require names within certain character limits*. 
    - Encrypted: **No** 
...
8. Start the runbook and ensure that it successfully provisions two virtual machines, an external load balancer. 
