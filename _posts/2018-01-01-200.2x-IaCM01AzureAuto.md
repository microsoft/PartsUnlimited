...
**Note:** If you delete the resource group and all resources within it using this de-provisioniong script i Task 4, run the provisioning runbook again to deploy the virtual machines, as  you will be using these resources in remaining labs for this course and they will be required.	  
