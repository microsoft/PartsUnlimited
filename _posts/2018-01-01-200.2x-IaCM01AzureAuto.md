...
2. Open the **AzureRM** page  (The current version at time of writing is **v6.12.0**) and locate version 5.5.0

    **Note:** Version 6.12.0 breaks the lab file workflow and you **must** use **V5.5.0** of the AzureRM module. If you use a later version your workflow will fail.
...
4. You will be brought into Azure and if prompted enter your Azure Automation account details. Select your **Azue Automation** account and click **OK**
...
6. You will be brought to the deployment and you can view its progress. It will update and deploy all modules associated with Azure RM. It cna yak eup to 30 mins to complete.
