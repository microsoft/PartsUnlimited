...
3. To approve or cancel the request, In the release pipeline progress propgress pane, click on the **Approve** or **cancel the deployment** button (circle with diagonal line through it).  
