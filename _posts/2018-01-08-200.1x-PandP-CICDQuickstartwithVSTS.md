...
- **Import Source Code into your VSTS Account with Git:** In this step you will download the PartsUnlimited source code, and then push it to your own Visual Studio Team Services account.

- **Setting up Service Endpoint in VSTS:** In this step you will set up Service Endpoint in VSTS for Continues Deployment be able to deploy to Azure.

- **Continuous Integration:** In this step you will import Build definition template and configure it for your repository.

- **Continuous Deployment:** In this step you will import Release definition template and configure it for your build definition.

- **Export Build and Release Definitions from VSTS:** In this step you will export Build and Release Definitions into your local repository.

- **Confirming successful deployment to Azure:** In this step you will confirm the status of your deployment in VSTS and Azure.
...
6. You can return anbd access your project repo files at any time by going to **Code** > **Files**
