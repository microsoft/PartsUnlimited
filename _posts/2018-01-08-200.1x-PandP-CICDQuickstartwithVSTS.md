...
3. To approve/reject the request navigate to the **Release** tab, click on ![](../assets/cicdquickstart-jan2018/26.png) , optionally leave a comment and click on the **Approve** or **Reject** button.  
...
4. In Azure, find your App Service with the name **pudncore** and open its URL (this is the production site).
