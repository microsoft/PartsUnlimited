...
Firstly you need to install git in yur local environment, see the page <a href="https://git-scm.com/book/en/v2/Getting-Started-Installing-Git">1.5 Getting Started - Installing Git</span></a> for detaisl on how to install git in your local environment. 

The steps we outline below will be based on a Windows installatin but you could also perform similar tasks on linux or mac if you needed using the git bash.
