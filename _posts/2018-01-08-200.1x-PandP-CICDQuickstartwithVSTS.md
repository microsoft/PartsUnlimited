...
11. Select the **Variables** tab, followed by the **Process variables**. The issues here are the **Passwords** where you will need to select the **Lock** icon next to them and type in a new one, you can use the password of **Pa$$w0rd01** if you wish. For the rest of the values please change these to a unique name by adding your initials to the end of them.
	...
	**Note**: You just need to add your initials to the end of the current values but you should be aware of the following in case it is needed.
	- The parameter values need to adhere to requirements for the Azure resource they are deploying. If they do not meet those requirements you may receieve an error when deploying. 
