...
### Task 4: Import Continuous Integration Build Definition into VSTS and kcik off a build
...
5. Make sure that the **Continuous deployment trigger** is on, by selecting the Lighting bolt to the top right of the artifact. 
...
11. Select the **Variables** tab, followed by the **Process variables**. The issues here are the **Passwords** where you will need to select the **Lock** icon next to them and type in a new one, yo cna use the password of **Pa$$w0rd01** if you wish. For the rest of the values please change these to a unique name by adding your initials to the end of them.

	![](../assets/cicdquickstart-jan2018/cdshot6.png)

	**Note**: You just need to add your initials to the end of the current values but you shoudl be awar of the following in case it is needed.
	- The parameter values need to adhere to requirements for the Azure resource they are deploying. If they do not meet those requirements you may receieve and error when deploying. 
...
12. Up until now, when all errors have rectified, the **Save** option was not available, it was greyed out. However, now that there are no errors present, all that is left to do is to click **Save** to save the release. 
	...
	**Note**: If you had to defined an empty release definition before, then it can be now deleted by clicking on the dropdown arrow next to the empty definition and selecting **Delete** if you wish to do so.
...
1. Navigate to the **Builds tab. Click on the ellipsis **(...)** button next to the build de**finition you would like to export and select **Export**. This will trigger a download of the build definition in JSON format. Click **Save as** and place this file in the `templates\build definitions` directory of your local repository.i.e. **C:\Repo\Parts-Unlimited\templates\build definitions**, you can append your initials to it if you like or overwite it, and verify it downloads successfully.

	![](../assets/cicdquickstart-jan2018/ex1.png)

2. Navigate to the **Releases** tab. Click on the dropdown arrow next to the release definition you would like to export and select **Export**. This will trigger a download of the release definition in JSON format. Click **Save as** and place this file in the `templates\release definitions` directory of your local repository.i.e. **C:\Repo\Parts-Unlimited\templates\release definitions**, you can append your initials to it if you like or overwite it, and verify it downloads successfully.

![](../assets/cicdquickstart-jan2018/ex2.png)

3. Open the git cmd window and go to your locla repo location i.e.**C:\Repo\Parts-Unlimited** . 
...
5. The uploads commits to the remote repository. Go to your VSTS repo and verify the files have been pushed up to the VSTS repo as expected.
