...
2. Navigate to the **Build & Release** tab and click on *Builds*. and click on the **+ Import** button.

	![](../assets/cicdquickstart-jan2018/shot4.png)

3. Click on **Browse** and go to your local repo which you created in Task 2, i.e. something like **C:\Repo\Parts-Unlimited** then go to the folder  **templates\build definitions** and select the file **PartsUnlimited-CI.json** and click on **Import** button.

	![](../assets/cicdquickstart-jan2018/shot5.png)

4. Once the import has done you will need to update some information. Click on the **Process** heading and in the agent queue select **Hosted VS2017** in the hosted section. If this is already filled in please select the option with the **VS logo** beside it.

	![](../assets/cicdquickstart-jan2018/shot8.png)

5. Select the **Get Sources** bar.

	![](../assets/cicdquickstart-jan2018/shot6.png)

6. Make sure that that the branch that has been selected is `master` and it is using this project. 

	![](../assets/cicdquickstart-jan2018/shot7.png)

7. Now click **Save & queue**. The build should now run and complete successfully, it may take up to 10 minutes to complete.
