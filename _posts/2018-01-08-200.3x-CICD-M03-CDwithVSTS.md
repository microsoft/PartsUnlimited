---
layout: page
title:  DevOps200.3x Continuous Integration and Continuous Deployment - CD with VSTS
category: CICD
order: 3
---


<h1><span style="color: #0000CD;"> Continuous Deployment with Visual Studio Team Services</span></h1>
...
Please refer to the [Continuous Integration with Visual Studio Team Services](../HOL-Continuous_Integration/README.md) in order to see how the CI build was set up.
