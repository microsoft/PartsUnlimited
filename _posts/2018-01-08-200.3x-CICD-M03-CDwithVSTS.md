...
1. Log into your VSTS account and click on the **Build and Releases > Build** hub.

2. Click the Build that you configured in the Continuous Integration lab, and click **Edit**, as per the screenshot below. 
