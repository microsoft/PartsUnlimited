...
![](</PartsUnlimited/assets/fiservicefabric/publish.png>)
...
![](</PartsUnlimited/assets/fiservicefabric/publish-location.png>)
...
![](</PartsUnlimited/assets/fiservicefabric/settings.png>)
...
![](</PartsUnlimited/assets/fiservicefabric/service-fabric.png>)

We can drill down on the cluster and see our active node.

![](</PartsUnlimited/assets/fiservicefabric/node-cluster.png>)

Now navigate to http://localhost:5000 to check to see if the PartsUnlimited website is active.

![](</PartsUnlimited/assets/fiservicefabric/localhost-parts-unlimited.png>)
...
![](</PartsUnlimited/assets/fiservicefabric/azure4.png>)
...
![](</PartsUnlimited/assets/fiservicefabric/azure5.png>)

![](</PartsUnlimited/assets/fiservicefabric/azure6.png>)
...
![](</PartsUnlimited/assets/fiservicefabric/azure7.png>)
...
![](</PartsUnlimited/assets/fiservicefabric/azure12.png>)

**Step 10.** This is the Azure Service Fabric Explorer. 

![](</PartsUnlimited/assets/fiservicefabric/service-fabric-no-apps.png>)
...
![](</PartsUnlimited/assets/fiservicefabric/azure11.png>)
...
![](</PartsUnlimited/assets/fiservicefabric/node.png>)
...
![](</PartsUnlimited/assets/fiservicefabric/node-stop.png>)
...
![](</PartsUnlimited/assets/fiservicefabric/powershell1.png>)

We can see in the portal the actual instances being tampered with in the Service Fabric Explorer.

![](</PartsUnlimited/assets/fiservicefabric/explorer-fail.png>)
...
- [Fault Injection for Service Fabric (Hackathon Starter)](FaultInjectionServiceFabricStarter)