...
2. Click on the **Deploy** tab, then highlight **Azure App Service Deploy** and click **Add**add the task.

	![](/PartsUnlimited/assets/cd2/AzureAppServiceDeployAdd.png)

3. Click on the "Azure App Service Deployment" Task and configure it as follows
