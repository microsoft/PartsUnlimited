...
10. Click on the **Variables** tab, and under Process variables click **+ Add** and add the following variable names and values, as per the below screenshot
