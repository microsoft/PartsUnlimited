...
17. Save the Release Definition.
	...
	> **Note:** We have now configured our build and release definitions so that Deployment to **Dev** environment will be triggered after a new Build Artifact is created.<br/> Deployment to **Staging** can be triggered on successful deployment to **Dev**.<br/>	Deployment to **Production** can be triggered on successful deployment to *Staging**.
...
3. Still In the **Create new release** dialogue select **Deployment Trigger** and configure the Environment and trogger values as follows, and click **Queue**
