...
3. Still In the **Create new release** dialogue select **Deployment Trigger** and choose the Environment to be **Dev** and the trigger to be **Automated after relase creation** and click **Queue**

	![](/PartsUnlimited/assets/cd2/Createrelease3.png)


3. Click the **Release-x** link to open and view the release.
