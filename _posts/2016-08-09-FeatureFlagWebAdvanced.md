...
![](</PartsUnlimited/assets/advancedfeatureflagweb/new-folder.png>)
...
![](</PartsUnlimited/assets/advancedfeatureflagweb/new-class.png>)
...
![](</PartsUnlimited/assets/advancedfeatureflagweb/iis-express.png>)

![](</PartsUnlimited/assets/advancedfeatureflagweb/splash.png>)
...
![](</PartsUnlimited/assets/advancedfeatureflagweb/manage.png>)

**Step 5.** Now select 'Australia' and then save it.

![](</PartsUnlimited/assets/advancedfeatureflagweb/location.png>)

**Step 6.** Now navigate to the 'Breaks' section from the main navigation.

![](</PartsUnlimited/assets/advancedfeatureflagweb/breaks.png>)

Notice the bulk buy is not available yet. This should change in a couple of minutes.

![](</PartsUnlimited/assets/advancedfeatureflagweb/break-no-bulk.png>)
...
![](</PartsUnlimited/assets/advancedfeatureflagweb/break-bulk.png>)
...
- [Feature Flag for a Mobile Solution](FeatureFlagMobile)