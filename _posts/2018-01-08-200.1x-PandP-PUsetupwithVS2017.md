...
4. Install [NodeJS](https://nodejs.org/en/) (the current version, as of Jan 2018, is 8.9.4 LTS version. Later versions may be fine also but have not been verified as of todays date, Jan 2018). Install the appropriate version for your environment i.e. for Windows 10 users use node-v8.9.4-x64.msi available by clicking the box for **8.9.4 LTS - Recommended For Most Users** as per the screenshot below.
