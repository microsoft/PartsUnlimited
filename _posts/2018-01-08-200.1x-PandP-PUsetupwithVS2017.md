...
3. Install <a href="https://dotnet.microsoft.com/download" target="_blank"><span style="color: #0066cc;" color="#0066cc">.NET Core 2.2</span></a> by choosing the .NET Core SDK from the **Download .NET** in the link provided. Once installed, check the `dotnet` version details by running the commands
