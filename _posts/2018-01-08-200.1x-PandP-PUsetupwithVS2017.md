...
- **Build Errors and Solutions**
    ...
    6. Also, You may see an error related to **bower** being deprecated and promptig you to migrate your application to **Yarn**. It is fine to ignore that error message for our purposes. 
