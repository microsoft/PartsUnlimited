...
- **Build Errors and Solutions**
    ...
    3. If you are continuing to get errors, sometimes just closing and then re-opening Visual Studio and trying to build the solution can work, otherwise you can also try the following.
        - Close Visual Studio.
