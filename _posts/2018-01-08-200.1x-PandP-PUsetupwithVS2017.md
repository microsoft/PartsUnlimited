...
- **Build Errors and Solutions**
    ...
    5. Finally you could also remove the solution from Visual Studio and delete the repo, then try again from the start.
...
6. Perform some actions on the PartsUnlimted website in the browser it launched in
