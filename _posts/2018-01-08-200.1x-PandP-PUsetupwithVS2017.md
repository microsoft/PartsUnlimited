...
- **Build Errors and Solutions**
    ...
    2. If you continue to get node-sass errors check the version of **nodejs** that you have installed by running the command
        ...
        - In windows you can do this in **Control Panel** > **Program and Features**, right clicking Node.js and selecting ununstall and completign the wizard. 

        - Once unsinatlled, install **version 6.12.3** as outlined in **Task 1: Step 4** above.

        - Once installed, try build the solution again.

    3. If you are continuing to get errors
        - Close Visual Studio.
    ...
    4. If you are continuing to get errors, remove the solution from Visual Studio and delete the repo you can try removing all npm packages or uninstalling and re-installing the node-sass package using the command
...
6. perform some actions on the PartsUnlimted website

7. Return to the Visual Studio debugger and scroll throuhg the Output on the **Output** tab. This is the debugger tracking the actions performed on the site by you.
...
- Start debugging PartsUnlimted website.
