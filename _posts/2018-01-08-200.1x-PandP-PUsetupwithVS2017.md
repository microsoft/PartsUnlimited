...
- This lab is used in course <a href="https://www.edx.org/course/introduction-devops-practices-microsoft-devops200-1x-0" target="_blank"><span style="color: #0066cc;" color="#0066cc">DevOps200.1x: DevOps Principles and Practices</span></a>
...
- **Build Errors and Solutions**
    ...
    5. As a last resport, you could also remove the solution from Visual Studio and delete the repo, then try again from the start.

    6. Finally, You may see an error related to **bower** being deprecated and promptig you to migrate your application to **Yarn**. It is fine to ignore that error message for our purposes.
