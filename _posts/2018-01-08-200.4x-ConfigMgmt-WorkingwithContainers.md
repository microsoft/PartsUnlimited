...
9. Verify the **builddemo** folder you created earlier is present in the image you created. You can open the text file within this folder to verify it is the same file if you wish. This demonstrates that changes made within containers can be retained by committing the container to an image.
