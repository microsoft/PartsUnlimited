...
5. Familiarise yourself with the contents of the three docker files. 
    ...
    - Open the docker-compose.yml file 
        ...
        - Note that this is calling the dockerfile to build the web site container.
    ...
    - Open the docker-compose.override.yml file
        ...
        - Note that this building the db container and the network, it is also providing for additional configuration for the website container. 
    ...
    - Open the dockerfile
        ...
        - Note that this is building the website container. It is 
