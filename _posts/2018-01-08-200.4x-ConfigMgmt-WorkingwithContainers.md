...
<a href="https://docs.docker.com/docker-for-windows/" target="_blank"><span style="color: #0066cc;" color="#0066cc"> Docker for Windows</span></a>
...
1. Navigate to the <a href="https://docs.docker.com/install/" target="_blank"><span style="color: #0066cc;" color="#0066cc"> Install Docker</span></a>page, locate the setup instructions for Windows, instructions for <a href="https://docs.docker.com/docker-for-windows/" target="_blank"><span style="color: #0066cc;" color="#0066cc"> Docker for Windows</span></a>.

2. Read any notes or important sections prior to install, then download and install the Docker engine. You may need to restart to complete the depending on your installation.
Note: The following commands will be the same in each environment.

1. Run the below command and verify help command options are returned
...
2. Run the below command and verify it returns version information. It should return the client and server details for version, API version, GO version, Git commit, date built and OS/Architecture

```
Docker version 
```

3. Run the belowcommand and verify it returns just the version information

```
Docker --version 
```

4. Run the belowcommand docker-compose --version to get the docker compose version. Docker-compose allows you write .yml files to configure an application’s services in your containers.

```
docker-compose --version 
```

5. Run the belowcommand docker-machine -- version to get the docker machine version. Docker machine allows you to manage host machines

```
docker-machine -- version 
```

6. Run the below command. This will return various information about number of containers, running, images, architecture, and various settings. Scroll through them to get a feeling for what the individual elements are referring to.
...
7. This will return various information about number of containers, running, images, architecture, and various settings. Scroll through them to get a feeling for what the individual elements are referring to.
...
8. Open a browser and go to the IP address you noted in the previous step i.e. type 
**http://<IPAddresss value>**
