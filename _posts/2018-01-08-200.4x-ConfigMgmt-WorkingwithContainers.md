...
3. Run the below command and verify help command options are returned
...
4. Run the below command and verify it returns version information. It should return the client and server details for version, API version, GO version, Git commit, date built and OS/Architecture

    ```
    Docker version 
    ```

5. Run the belowcommand and verify it returns just the version information

    ```
    Docker --version 
    ```

6. Run the belowcommand docker-compose --version to get the docker compose version. Docker-compose allows you write .yml files to configure an application’s services in your containers.

    ```
    docker-compose --version 
    ```

7. Run the belowcommand docker-machine -- version to get the docker machine version. Docker machine allows you to manage host machines

    ```
    docker-machine -- version 
    ```

8. Run the below command. This will return various information about number of containers, running, images, architecture, and various settings. Scroll through them to get a feeling for what the individual elements are referring to.
...
9. This will return various information about number of containers, running, images, architecture, and various settings. Scroll through them to get a feeling for what the individual elements are referring to.
