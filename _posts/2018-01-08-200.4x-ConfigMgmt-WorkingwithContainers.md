...
5. Familiarise yourself with the contents of the three docker files. 
    ...
    - Open the **dockerfile**
        ...
        - This file is building the partsunlimitedwebsite container. The following points are of note: 
           ...
           - opens port 80 to listen on using the <a href="https://docs.docker.com/engine/reference/builder/#expose" target="_blank">EXPOSE<span style="color: #0066cc;" color="#0066cc"> instruction.
