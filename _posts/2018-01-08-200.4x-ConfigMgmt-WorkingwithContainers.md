...
2. Run the below command
    ...
    **db_1      |VERBOSE: Started SQL Server**
    ...
    ![Docker contianer run](../assets/workingwithcontainers-jan2018\dockercomposerunning.png)
    ...
    - **Potential errors and issues:**
        ...
        - If you receive errors stating something like the below, check the **COPY** cmd in the Dockerfile to ensure the files are where you intend them to be
...
5. Open a web browser and enter the IP address in the addres bar **http://< Container IP Address >**. You should now see the PartsUnlimited web site, which is being run from within your container and accessible via your browser.
    ...
    ![Docker contianer run](../assets/workingwithcontainers-jan2018\puwebsite_runningincntr.png)
   
   
   - **Potential errors and issues:**
     - If you receive a page such as n the screen shot below, which is prompting to apply migrations to the db. his may be because you are calling an incorrect image from earlier. You shoudl re-trace your steps and ensure you are using the correct image, if it is still appearing ing after doing that, you may want to re-create the image form earlier in the lab.
...
8. Run some sql commands as below, and verify you get a successful output of the , after ypu type the command then type **go** and press *Enter** to get the output.
...
11. Return to your web browser, refresh the page and verify the PartsUnlimited web site is no loinger available.
