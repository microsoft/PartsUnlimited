...
4. Create a new file called **myfile.txt** and add some text, press return after you type the text, and then exit the copy con command and copy the file by running the below commands
