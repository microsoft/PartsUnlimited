...
6. Exit the container by running the command
    ...
    You should retrun to a command prompt and th header in the command paompt window should no longwe 
...
8. Verify that you don’t see the file on your host by going to the C:\ directory and running the command 
