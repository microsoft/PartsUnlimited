...
3. Start a new command prompt to inspect the running containers and run the following command to determine the IP Address of the parstunlimted website container
...
8. Ensure you are in the folder where your **docker-compose** files are located i.e. **C:\dclab** and now build the website container again by runing the docker-compose up command as below
...
14. Run some sql commands as below, and verify you get a successful output of the 
