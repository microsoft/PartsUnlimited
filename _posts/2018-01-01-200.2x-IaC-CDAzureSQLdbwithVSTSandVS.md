...
1.	 Under **Copy Files** task, click on the symbol next to Source folder and Target folder. Copy paste the respective values shown in each field. Now, navigate to  the **Triggers** tab and enable the **Continuous integration (build whenever this branch is updated)** checkbox, and click **Create**.  
