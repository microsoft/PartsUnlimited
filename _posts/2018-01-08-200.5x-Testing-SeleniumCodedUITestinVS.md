...
- Visual Studio 2017
- Google Chrome (recent edition) [https://www.google.com.au/chrome/browser/features.html](https://www.google.com.au/chrome/browser/features.html)
- Access to the PartsUnlimited website deployed at [http://cdrm-pu-demo-dev.azurewebsites.net/](http://cdrm-pu-demo-dev.azurewebsites.net/)
...
1. In a Chrome browser, launch the PartsUnlimited web application by going to the URL [http://cdrm-pu-demo-dev.azurewebsites.net/](http://cdrm-pu-demo-dev.azurewebsites.net/) 
