...
1.	Go to the Azure portal and when prompted, sign in with the Microsoft Account that is the Service Administrator of your Azure subscription. 
...
4.	Connect to the VM, you can use **ssh** in a linux or mac environment or use **PuTTy** from windows.  
...
10.	Once completed, on your local machine start Google Chrome and browse to 
**https:// 
...
13.	On the **Welcome to Chef** page, fill out the form to create a Chef user account by providing
- Full Name = **your first and last name**, 
- Company name = **cheflabs**
- Email =**the email address of your Microsoft account**
- Username = **student**
- Password = **Pa55w.rd1234**

and selecting the **I agree to the Terms of Service and the Master License and Services Agreement** checkbox and click **Get Started**. 
