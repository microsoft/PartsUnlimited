...
![Screenshot of the Visual Studio 2017 dashboard with the Tools Get Tools and features .. menu items selected and highlighted](../assets/feb2019-deployapptoaks\walkthrough-javaappinappservice1.png)
...
1. Create a file named **azure-vote.yaml**, and then copy it into the following `YAML` definition. If you use the Azure Cloud Shell, you can create this file using **vi** or **nano** as if working on a virtual or physical system:
