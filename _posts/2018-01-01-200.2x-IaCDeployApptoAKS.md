...
7. These logs include the `stdout` and `stderr` streams from the container.
    ...
    If you havw time you can click around some more within the settings to get a feel for structure and configuration, looking at the **Cluster**, **Node**, **Controller** and **Container** settings.
