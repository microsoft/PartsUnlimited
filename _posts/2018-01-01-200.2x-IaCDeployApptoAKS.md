...
2. It can take up to 5 minutes ot deploy the AKS cluster. After a few minutes, the command completes and returns JSON-formatted information about the cluster.
