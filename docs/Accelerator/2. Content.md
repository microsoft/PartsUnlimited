...
Alternatively, the DocumentDB SDK provides the ability to create attachments as seen by the following example:
...
Alternatively, the Project Oxford VisionAPI SDK can be used to accomplish the same result as below:
