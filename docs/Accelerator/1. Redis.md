...
The setting of the expiry time is  dependent on a balance of application requirements, cost of reading the source data and the impact of reading stale data within the application.
