...
The setting for TTL will be dependent on the application requirements and the balance between requesting the source data from the underlying data source and the impact of reading stale data.
