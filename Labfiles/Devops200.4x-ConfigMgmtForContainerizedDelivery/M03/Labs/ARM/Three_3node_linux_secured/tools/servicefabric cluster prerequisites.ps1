Param(    
    [string] $subscriptionId = "8791549a-6c99-40d9-8390-d316ee32d284",
    [string] $resourceGroupName = 'fabricextresources',
    [string] $resourceGroupLocation = 'westeurope',
    [string] $keyVaultName = "servicefabricdemovault",
    [string] $clusterDns = 'fabricclusterwe',
    [string] $certName = 'fabricclusterwe-pri',
    [string] $certPassword = "P@ssw0rd",
    [string] $certOutputPath = "c:\temp"
    )
